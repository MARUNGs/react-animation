...
function Svg() {
  return (
    <>
      <Wrapper>
        <SvgTag xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <motion.path
            variants={svg}
            initial="start"
            animate="end"
            // 특정 property의 animation을 각각 다른 타이밍에 단독으로 변경하는 방법?
            // default: 기본 property 스타일이 적용된다.
            // fill 속성은 별도로 설정한 애니메이션에 맞춰서 진행될 것이다.
            transition={{
              default: { duration: 5 },
